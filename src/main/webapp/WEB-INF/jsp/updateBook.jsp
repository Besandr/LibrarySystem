...
<div class="d-flex justify-content-center">
    <form action="${contextPath}/admin/bookManagement/updateBook.do" method="post">
            ...
            <div id="authorSelects">
                ...
                <c:if test="${not empty form.oldAuthorsId}">
                    <c:forEach items="${form.oldAuthorsId}" var="authorId">
                        <div class="row justify-content-center align-items-center" id="oldAuthor${authorId}">
                            <div class="col-md-6">
                                <select class="custom-select" name="oldAuthorId">
                            ...
                            <div class="col-md-1">
                                <button class="btn btn-sm brown-button" type="button>" onclick="deleteNodeById('oldAuthor${authorId}')">-</button>
                            </div>
                        </div>
                        <br>
                    </c:forEach>
            ...
            <div id="keywordSelects">
                ...
                <c:if test="${not empty form.oldKeywordsId}">
                    <c:forEach items="${form.oldKeywordsId}" var="keywordId">
                        <div class="row justify-content-center align-items-center" id="oldKeyword${keywordId}">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-1">
                                <button class="btn btn-sm brown-button" type="button>" onclick="deleteNodeById('oldKeyword${keywordId}')">-</button>
                            </div>
                        </div>
                        <br>
                    </c:forEach>
                ...
                <div id="keywordSelect">
                    <select class="custom-select mx-sm-1" name="oldKeywordsId">
        ...
        <div class="form-row justify-content-center">
            <div class="col-md-6">
                <label class="text-center" for="bookIssueYear">
        ...
        <div class="d-flex justify-content-center">
            <button class="btn btn-lg brown-button mt-3"><fmt:message key="bookManagement.changeBookProperties"/></button>
        </div>
    </form>
</div>

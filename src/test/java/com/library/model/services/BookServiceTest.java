...
public class BookServiceTest {
    ...
    public void testDeleteAuthorsShouldDeleteTwoAuthors() throws SQLException {
        ...
        when(mockAuthorBookDao.doesAuthorHasBooks(author1)).thenReturn(false);
        when(mockAuthorBookDao.doesAuthorHasBooks(author2)).thenReturn(true);
        when(mockAuthorBookDao.doesAuthorHasBooks(author3)).thenReturn(false);
